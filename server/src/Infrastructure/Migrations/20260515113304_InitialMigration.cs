        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CriticalityLevelId = table.Column<Guid>(type: "uuid", nullable: false),
                    OwnerStakeholderId = table.Column<Guid>(type: "uuid", nullable: true),
                    TestEnum = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestorId = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    ...
                    ExpectedBusinessBenefit = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Remarks = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ManagerId = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    FinanceAdminId = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    CreatedBy = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW() AT TIME ZONE 'UTC'"),
                    UpdatedBy = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SponsorshipRequests_AspNetUsers_FinanceAdminId",
                        column: x => x.FinanceAdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SponsorshipRequests_AspNetUsers_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionById = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SponsorshipRequests_FinanceAdminId",
                table: "SponsorshipRequests",
                column: "FinanceAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_SponsorshipRequests_ManagerId",
                table: "SponsorshipRequests",
                column: "ManagerId");
